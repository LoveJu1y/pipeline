...
module RegisterFile(
	...
	input  wire clk                      ,
	input  wire RegWrite                 ,
	input  wire[5 -1:0]  Read_register1 , 
	input  wire[5 -1:0]  Read_register2 , 
	input   wire[5 -1:0]  Write_register ,
	input   wire[32 -1:0] Write_data     ,
	output  wire[32 -1:0] Read_data1     , 
	output  wire[32 -1:0] Read_data2
);
